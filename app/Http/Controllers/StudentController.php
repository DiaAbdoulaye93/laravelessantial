    ...
    public function getStudents()
    {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $actionBtn = '<a href="javascript:void(0)" class="edit btn btn-success"><i class="fa fa-pencil"> </i></a> <a href="javascript:void(0)" class="delete btn btn-danger"><i class="fa fa-trash"></i></a>';
                    return $actionBtn;
                })
                ->rawColumns(['action'])
                ->make(true);
